...
namespace DataProtection.Web.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(ExampleDbContext context, IDataProtectionProvider 
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Color,Stock,Price,CategoryId")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Color,Stock,Price,CategoryId")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
